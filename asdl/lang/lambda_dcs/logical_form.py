...
from asdl.asdl_ast import AbstractSyntaxNode, RealizedField
...
def logical_form_to_ast(grammar, lf_node):
    if lf_node.name == 'lambda':
        ...
        op_field = RealizedField(prod['op'], AbstractSyntaxNode(grammar.get_prod_by_ctr_name(op_name)))
        ...
        ast_node = AbstractSyntaxNode(prod, [var_field, body_field])
